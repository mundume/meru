    ...
    c.fn.dzsparallaxer = function (b) {
        ...
        this.each(function () {
            function n() {
                ...
                a.get(0) &&
                    (a.get(0).api_set_scrollTop_is_another_element_top =
                        function (a) {
                            z = a;
                        });
                        ...
                        0 < a.children("img").length
                            ? 0 < a.find(".divimage").length &&
                              (V &&
                                  ...
                                  a
                                      .find(
                                          ".dzsparallaxer--target-con .divimage"
                                      )
                                      .css(
                                          "background-image",
                                          "url(" + V + ")"
            ...
            function W(g, d) {
                ...
                if (!1 !== O) {
                    ...
                    760 > x
                        ? a.addClass("under-760")
                        : a.removeClass("under-760");
                    500 > x
                        ? a.addClass("under-500")
                        : a.removeClass("under-500");
                    ia && clearTimeout(ia);
            ...
            function na() {
                ...
                b.settings_substract_from_th &&
                    (k -= b.settings_substract_from_th);
                b.settings_clip_height_is_window_height &&
                ...
                g.attr("data-forcewidth_ratio") &&
                    (g.width(
                        Number(g.attr("data-forcewidth_ratio")) * g.height()
                    ),
            ...
            function u(n, d) {
                ...
                isNaN(l) && (l = 0);
                n &&
                    "on" == b.init_functional_remove_delay_on_scroll &&
                    (D = !1);
                var f = {
                    force_vi_y: null,
                    from: "",
                ...
                null != f.force_th &&
                    (f.force_th_only_big_diff
                        ...
                        : (k = f.force_th));
                !1 === O &&
                    ((p = window.innerHeight), l + p >= a.offset().top && aa());
                if (
                    0 != k &&
                    !1 !== O &&
                    ("scroll" == b.settings_mode ||
