    ...
    h("7", tinymce.util.Tools.resolve),
            ...
            var a = function (a) {
                ...
                b = function (a, b) {
                    for (var c = 0; c < a.length; c++)
                        if (
                            ...
                            (!a[c].end ||
                                b.lastIndexOf(a[c].end) ===
                                    b.length - a[c].end.length)
                        )
                            return a[c];
                },
                c = function (a, b, c, d) {
                ...
                e = function (b, e, f, g) {
                    ...
                    for (i = 0; i < j.length; i++)
                        if (
                            ((h = j[i]),
                            void 0 !== h.end && c(h, e, f, g) && d(f, g, h))
                        )
                            return h;
                };
        ...
        g("6", [], function () {
            var a = [
                ...
                b = function (b) {
                    return void 0 !== b.textpattern_patterns
                        ? b.textpattern_patterns
                        : a;
                };
