                ...
                a.add("preview", function (a) {
                    ...
                    a.addCommand("mcePreview", function () {
                        a.windowManager.open({
                            title: "Preview",
                            width: parseInt(
                                a.getParam("plugin_preview_width", "650"),
                                10
                            ),
                            height: parseInt(
                                a.getParam("plugin_preview_height", "500"),
                                10
                            ),
                            html:
                            ...
                            onPostRender: function () {
                                ...
                                g.indexOf("=") != -1 &&
                                    ((g = a.getParam("body_id", "", "hash")),
                                    (g = g[a.id] || g));
                                var h = d.body_class || "";
                                h.indexOf("=") != -1 &&
                                    ((h = a.getParam("body_class", "", "hash")),
                                    (h = h[a.id] || ""));
                                var i =
                                    ...
                                    j = a.settings.directionality
                                        ? ' dir="' +
                                          a.settings.directionality +
                                          '"'
                                        : "";
                                if (
                                    ((b =
