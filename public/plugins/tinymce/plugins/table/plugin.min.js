        ...
        g("6", ["4", "2", "c", "d"], function (a, b, c, d) {
            ...
            return function (h, i, j) {
                    ...
                    return b
                        ? ((c = a.map(c.split(","), function (a) {
                          ...
                          a.grep(b.childNodes, function (b) {
                              return (
                                  a.inArray(c, b.nodeName.toLowerCase()) !== -1
                              );
                          }))
                        : [];
                }
                ...
                function u(a) {
                    return (
                        a &&
                        (!!ca.getAttrib(a.elm, "data-mce-selected") || a == j)
                    );
                }
                function v() {
                    var a = [];
                    return (
                        e(i.rows, function (b) {
                            e(b.cells, function (c) {
                                if (
                                    ca.getAttrib(c, "data-mce-selected") ||
                                    (j && c == j.elm)
                                )
                                    return a.push(b), !1;
                            });
                ...
                function Q() {
                    var a = v();
                    if (!l(i) || a.length != i.rows.length)
                        return ca.remove(a), z(), a;
                }
                function R() {
                    var a = v();
                    return (
                ...
                function X(a, b) {
                    ...
                    (c = T(a)), (d = c.y * $ + c.x);
                    do {
                        if (((d += b), (e = r(d % $, Math.floor(d / $))), !e))
                            break;
                        if (e.elm != a)
                            return (
                                ba.select(e.elm, !0),
                                ca.isEmpty(e.elm) && ba.collapse(!0),
                                !0
                            );
                    } while (e.elm == a);
                    return !1;
                            ...
                            if (
                                ...
                                do
                                    if (
                                        ...
                                        if (
                                            !o.getAttrib(h, "data-mce-selected")
                                        )
                                            break;
                                        k = h;
                                    }
                        ...
                        (n = d.dom.getParent(d.selection.getStart(), "table")),
                            ...
                            c(n.rows, function (a) {
                                c(a.cells, function (b) {
                                    if (
                                        t.getAttrib(b, "data-mce-selected") ||
                                        b == o
                                    )
                                        return u.push(a), !1;
                                });
            ...
            return function (d) {
                ...
                function J(a) {
                    var b = G(a, "height"),
                        c = parseInt(b, 10);
                    return (
                        Q(b) && (c = 0), !isNaN(c) && c > 0 ? c : o(a, "height")
                    );
                }
                function K(b) {
                    for (
                        ...
                        return (
                            ...
                            a.undoManager.transact(function () {
                                a.insertContent(g),
                                    ...
                                    a.dom.setStyles(
                                        h,
                                        a.settings.table_default_styles || {}
                                    );
                            }),
                            h
                        );
