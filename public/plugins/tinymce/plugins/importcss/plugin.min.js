        ...
        g("0", ["1", "2", "3", "4", "5"], function (a, b, c, d, e) {
            return (
                d.add("importcss", function (d) {
                    ...
                    function m(a, b) {
                        return (
                            null === b || a.settings.importcss_exclusive !== !1
                        );
                    }
                    function n(a, b, c) {
                                ...
                                if (n(a, c, f)) {
                                    ...
                                    if (g) {
                                        ...
                                        return (
                                            ...
                                            e.extend(
                                                {},
                                                j.settings.itemDefaults,
                                                { text: g.title, format: h }
                                            )
                                        );
                                    }
                                }
