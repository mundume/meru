            ...
            return (
                b.add("textcolor", function (b) {
                    ...
                    function k() {
                        var a = this;
                        a._color
                            ? h(a.settings.format, a._color)
                            : i(a.settings.format);
                    }
                    var l, m;
                    (m = {
                        forecolor:
                            b.settings.forecolor_rows ||
                            b.settings.textcolor_rows ||
                            5,
                        backcolor:
                            b.settings.backcolor_rows ||
                            b.settings.textcolor_rows ||
                            5,
                    }),
                        (l = {
                            forecolor:
                                b.settings.forecolor_cols ||
                                b.settings.textcolor_cols ||
                                8,
                            backcolor:
                                b.settings.backcolor_cols ||
                                b.settings.textcolor_cols ||
                                8,
                        }),
