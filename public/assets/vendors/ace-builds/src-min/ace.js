                ...
                m = function (e, t) {
                    ...
                    function Q(e, t, n) {
                        ...
                        var s = function (e) {
                            ...
                            if (i || y || t.$mouseHandler.isMousePressed)
                                return;
                            if (m) return;
                    ...
                    var R = function (e) {
                            if (y || !t.onCompositionStart || t.$readOnly)
                                return;
                            y = {};
                            if (E) return;
                            ...
                            (r.end.row = r.start.row),
                                ...
                                y.useTextareaForIME
                                    ? ((n.value = ""),
                                      ...
                                      (N = 0))
                                    : (n.msGetInputContext &&
                                          (y.context = n.msGetInputContext()),
                                      n.getInputContext &&
                                          (y.context = n.getInputContext()));
                        },
                        U = function () {
                            if (!y || !t.onCompositionUpdate || t.$readOnly)
                                return;
                            if (E) return W();
                            if (y.useTextareaForIME)
                        ...
                        if (y - a < 500 && i.length == 1 && !h)
                            ...
                            var N = t.selection.cursor,
                                C = t.selection.isEmpty()
                                    ? N
                                    : t.selection.anchor,
                                k = t.renderer.$cursorLayer.getPixelPosition(
                                    N,
                                    !0
                                ),
                                L = t.renderer.$cursorLayer.getPixelPosition(
                                    C,
                                    !0
                                ),
                            ...
                            var M = O(
                                ...
                                _ = O(
                                    e.clientX - A.left - L.left,
                                    e.clientY - A.top - L.top
                                );
                            M < 3.5 &&
                                _ < 3.5 &&
                                (n = M > _ ? "cursor" : "anchor"),
                            ...
                            if (l) {
                                ...
                                (g.style.width =
                                    ...
                                    (g.className = i.showInvisibles
                                        ...
                                        : "ace_cjk"),
                                    (g.textContent = i.showInvisibles
                                        ? i.SPACE_CHAR
                                        : p),
                                    u.appendChild(g);
                            } else if (d) {
