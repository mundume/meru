    ...
    var bt = /\s\s*/,
        xt = (function () {
            ...
            if (n) {
                ...
                r.addEventListener("test", i, a),
                    r.removeEventListener("test", i, a);
            }
            return t;
        })();
    function yt(i, t, a, e) {
                ...
                if (
                    ...
                    t.changedTouches
                        ...
                        $.test(a) &&
                            ...
                            (this.cropping = !1),
                            a === B &&
                                ((this.cropping = !0), pt(this.dragBox, c)));
                }
            },
            cropMove: function (t) {
                var e = this.action;
            ...
            change: function (t) {
                ...
                !s && t.shiftKey && (s = d && p ? d / p : 1),
                    this.limited &&
                        ...
                        (w =
                            f +
                            Math.min(n.height, a.height, a.top + a.height)));
                function x(t) {
                    switch (t) {
                        case T:
                            u + M.x > v && (M.x = v - u);
                ...
                var i = this.canvasData,
                    a = (function (t, e, i, a) {
                        var n = e.aspectRatio,
                            ...
                            L = Nt(
                                { aspectRatio: u, width: O, height: E },
                                "cover"
                            ),
                            ...
                            R = Nt(
                                { aspectRatio: n, width: O, height: E },
                                "cover"
                            ),
