...
+(function () {
    ...
    var DateTimePicker = (function ($, moment) {
        ...
        var DateTimePicker = (function () {
            ...
            DateTimePicker.prototype._getOptions = function _getOptions(
                options
            ) {
            ...
            DateTimePicker.prototype._isEnabled = function _isEnabled(
                granularity
            ) {
            ...
            DateTimePicker.prototype._dataToOptions =
                function _dataToOptions() {
            ...
            DateTimePicker.prototype._isInDisabledDates =
            ...
            DateTimePicker.prototype._isInEnabledDates =
                function _isInEnabledDates(testDate) {
                    return (
            ...
            DateTimePicker.prototype._isInDisabledHours =
                function _isInDisabledHours(testDate) {
                    return (
                        this._options.disabledHours[testDate.format("H")] ===
                        true
                    );
                };

            DateTimePicker.prototype._isInEnabledHours =
                function _isInEnabledHours(testDate) {
                    return (
                        this._options.enabledHours[testDate.format("H")] ===
                        true
                    );
                };
            ...
            DateTimePicker.prototype._indexGivenDates =
            ...
            DateTimePicker.prototype._indexGivenHours =
                function _indexGivenHours(givenHoursArray) {
            ...
            DateTimePicker.prototype._initFormatting =
                function _initFormatting() {
                    ...
                    this.use24Hours =
                        this.actualFormat.toLowerCase().indexOf("a") < 1 &&
                        this.actualFormat.replace(/\[.*?]/g, "").indexOf("h") <
                            1;
            ...
            DateTimePicker.prototype.extraFormats = function extraFormats(
                formats
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.disabledDates = function disabledDates(
                dates
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.enabledDates = function enabledDates(
                dates
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.daysOfWeekDisabled =
                function daysOfWeekDisabled(_daysOfWeekDisabled) {
                    if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.useCurrent = function useCurrent(
                _useCurrent
            ) {
            ...
            DateTimePicker.prototype.useStrict = function useStrict(
                _useStrict
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.sideBySide = function sideBySide(
                _sideBySide
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.allowInputToggle =
            ...
            DateTimePicker.prototype.disabledHours = function disabledHours(
                hours
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.enabledHours = function enabledHours(
                hours
            ) {
                if (arguments.length === 0) {
            ...
            DateTimePicker.prototype.multidateSeparator =
                function multidateSeparator(_multidateSeparator) {
                    if (arguments.length === 0) {
    ...
    var TempusDominusBootstrap4 = (function ($) {
        ...
        var TempusDominusBootstrap4 = (function (_DateTimePicker) {
            ...
            TempusDominusBootstrap4.prototype._getToolbar =
            ...
            TempusDominusBootstrap4.prototype._getTemplate =
            ...
            TempusDominusBootstrap4.prototype._fillMonths =
                function _fillMonths() {
                    var spans = [],
            ...
            TempusDominusBootstrap4.prototype._updateMonths =
                function _updateMonths() {
                    ...
                    months.each(function (index) {
                        if (
                            !self._isValid(
                                self._viewDate.clone().month(index),
                                "M"
                            )
                        ) {
            ...
            TempusDominusBootstrap4.prototype._updateYears =
            ...
            TempusDominusBootstrap4.prototype._fillHours =
                function _fillHours() {
            ...
            TempusDominusBootstrap4.prototype._fillMinutes =
                function _fillMinutes() {
            ...
            TempusDominusBootstrap4.prototype._fillSeconds =
                function _fillSeconds() {
            ...
            TempusDominusBootstrap4.prototype._fillTime = function _fillTime() {
                ...
                if (!this.use24Hours) {
                    ...
                    newDate = this._getLastPickedDate()
                        .clone()
                        .add(
                            this._getLastPickedDate().hours() >= 12 ? -12 : 12,
                            "h"
                        );
            ...
            TempusDominusBootstrap4.prototype.widgetPositioning =
                function widgetPositioning(_widgetPositioning) {
                    ...
                    if (
                        {}.toString.call(_widgetPositioning) !==
                        "[object Object]"
                    ) {
                        throw new TypeError(
            ...
            TempusDominusBootstrap4.prototype.widgetParent =
