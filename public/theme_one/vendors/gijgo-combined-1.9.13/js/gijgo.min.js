...
(gj.widget = function () {
    ...
    (gj.widget.prototype.getConfig = function (a, b) {
        ...
        (c = $.extend(!0, {}, gj[b].config.base)),
            ...
            (e = a.hasOwnProperty("iconsLibrary")
                ? a.iconsLibrary
                : c.iconsLibrary),
    ...
    (gj.widget.prototype.reload = function (a) {
        ...
        return (
            ...
            $.isArray(d.dataSource)
                ? ((c = gj[e].methods.filter(this)),
                  gj[e].methods.render(this, c))
    ...
    (gj.core = {
                ...
                if (/^\d+$/.test(a)) g = new Date(a);
                    ...
                    for (
                        ...
                        ["d", "dd"].indexOf(f[d]) > -1
                            ...
                            ? (i = gj.core.messages[
                                  c || "en-us"
                              ].monthShortNames.indexOf(e[d]))
                            : "mmmm" === f[d]
                            ? (i = gj.core.messages[
                                  c || "en-us"
                              ].monthNames.indexOf(e[d]))
        ...
        formatDate: function (a, b, c) {
            ...
            for (h = h.splice(1, h.length - 2), i = 0; i < g.length; i++)
                switch (((d = h[i] || ""), g[i])) {
                    ...
                    case "ddd":
                        f +=
                            gj.core.messages[c || "en-us"].weekDaysShort[
                                a.getDay()
                            ] + d;
                        break;
                    case "dddd":
                        f +=
                            gj.core.messages[c || "en-us"].weekDays[
                                a.getDay()
                            ] + d;
                        break;
                    case "m":
                    ...
                    case "mmm":
                        f +=
                            gj.core.messages[c || "en-us"].monthShortNames[
                                a.getMonth()
                            ] + d;
                        break;
                    case "mmmm":
                        f +=
                            gj.core.messages[c || "en-us"].monthNames[
                                a.getMonth()
                            ] + d;
                        break;
                    case "yy":
        ...
        height: function (a, b) {
            ...
            return (
                ...
                b &&
                    (c +=
                        parseInt(d.marginTop || 0, 10) +
                        parseInt(d.marginBottom || 0, 10)),
                c
            );
        },
        width: function (a, b) {
            ...
            return (
                ...
                b &&
                    (c +=
                        parseInt(d.marginLeft || 0, 10) +
                        parseInt(d.marginRight || 0, 10)),
                c
            );
        },
        ...
        initialize: function (a, b, c) {
            ...
            (d =
                ...
                "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary
                    ? "small" === b.size
                        ? (f.addClass("input-group-sm"),
                          a.addClass("form-control-sm"))
                        : "large" === b.size &&
                          (f.addClass("input-group-lg"),
                          a.addClass("form-control-lg"))
                    : "small" === b.size
                    ? f.addClass("small")
    ...
    (gj.dialog.methods = {
        ...
        initialize: function (a) {
            ...
            a.addClass(e.style.content),
                ...
                e.modal &&
                    a.wrapAll(
                        '<div data-role="modal" class="' + e.style.modal + '"/>'
                    ),
                e.autoOpen && a.open();
        },
        setSize: function (a) {
        ...
        renderHeader: function (a) {
            ...
            return (
                ...
                0 === b.length &&
                    ((b = $('<div data-role="header" />')), a.prepend(b)),
                b.addClass(e.style.header),
                (c = b.find('[data-role="title"]')),
                0 === c.length &&
                    ((c = $('<h4 data-role="title">' + e.title + "</h4>")),
                    b.append(c)),
        ...
        resizable: function (a) {
            ...
            a.append(
                ...
                ).draggable($.extend(!0, { horizontal: !1 }, b))
            ),
                a.append(
                    $(
                        '<div class="gj-resizable-handle gj-resizable-e"></div>'
                    ).draggable($.extend(!0, { vertical: !1 }, b))
                ),
                a.append(
                    $(
                    ...
                    (!1 === b
                        ...
                        : (a.close(),
                          ...
                          a
                              ...
                              .removeClass(c.style.header),
                          a
                              .find('[data-role="title"]')
                              .removeClass(c.style.headerTitle),
                          a.find('[data-role="close"]').remove(),
                          a
                              .find('[data-role="body"]')
                              .removeClass(c.style.body),
                          a
    ...
    (gj.dialog.widget.prototype.getHTMLConfig =
        gj.dialog.methods.getHTMLConfig),
    (function (a) {
    ...
    (gj.droppable.methods = {
        ...
        createMouseUpHandler: function (a) {
            return function (b) {
                ...
                (a.isDragging = !1),
                    gj.droppable.methods.isOver(a, c) &&
                        gj.droppable.events.drop(a);
            };
        },
        isOver: function (a, b) {
            var c = a.offset().top,
    ...
    (gj.grid.methods = {
            ...
            return (
                ...
                this.find("thead > tr > th").each(function () {
                    ...
                    (d.title = c),
                        d.field || (d.field = c),
                        d.events &&
                            (d.events = gj.grid.methods.eventsParser(d.events)),
                        a.columns.push(d);
                }),
                a
            );
        ...
        eventsParser: function (events) {
            ...
            for (list = events.split(","), i = 0; i < list.length; i++)
                (position = list[i].indexOf(":")) > 0 &&
                    ...
                    (func = $.trim(
                        list[i].substr(position + 1, list[i].length)
                    )),
        ...
        initialize: function (a) {
            ...
            gj.grid.methods.localization(b),
                0 === c.length
                    ? ((c = $('<div data-role="wrapper" />').addClass(
                          b.style.wrapper
                      )),
                      a.wrap(c))
                ...
                (g = $('<th data-field="' + (c[i].field || "") + '" />')),
                    ...
                    "selectRow" === c[i].role
                        ? ((j = g.find('input[data-role="selectAll"]')),
                          0 === j.length &&
                              ((j = $(
                                  '<input type="checkbox" data-role="selectAll" />'
                              )),
                              g.append(j),
                        ...
                        : ((h = $('<div data-role="title"/>').html(
                          ...
                          c[i].sortable &&
                              ...
                              h.on(
                                  "click",
                                  gj.grid.methods.createSortHandler(a, c[i])
                              ))),
                    c[i].hidden && g.hide(),
                    f.append(g);
            e.empty().append(f);
        ...
        autoGenerateColumns: function (a, b) {
            ...
            if (((g.columns = []), b.length > 0)) {
                for (
                    c = Object.getOwnPropertyNames(b[0]), f = 0;
                    f < c.length;
                    f++
                )
                    (d = b[0][c[f]]),
            ...
            for (
                b = a.data(),
                    ...
                    b.autoGenerateColumns &&
                        gj.grid.methods.autoGenerateColumns(a, c),
                    g = a.children("tbody"),
                    "checkbox" === b.selectionMethod &&
                        "multiple" === b.selectionType &&
                        a
            ...
            for (
                h = a.data(),
                    ...
                    "checkbox" !== h.selectionMethod &&
                        b.on(
                            "click",
                            gj.grid.methods.createRowClickHandler(a, e)
                        ),
                    g = 0;
                g < h.columns.length;
                g++
                ...
                for (h in c.events)
                    c.events.hasOwnProperty(h) &&
                        b.on(
                            ...
                            gj.grid.methods.createCellEventHandler(
                                c,
                                c.events[h]
                            )
                        );
        ...
        renderDisplayElement: function (a, b, c, d, e, f) {
            ...
            "checkbox" === c.type && gj.checkbox
                ...
                ? "create" === f &&
                  (b.append(
                      $("<span/>").addClass(c.icon).css({ cursor: "pointer" })
                  ),
        ...
        formatText: function (a, b) {
            return (
                ...
                b.decimalDigits &&
                    a &&
                    (a = parseFloat(a).toFixed(b.decimalDigits)),
                a
            );
        },
            ...
            return (
                $.isArray(b)
                    ...
                    : e &&
                      ...
                      ((d = b[e.mapping.totalRecordsField]) && !isNaN(d)) ||
                          (d = 0)),
                a.data("records", c),
        ...
        filter: function (a) {
            ...
            d.params[d.paramNames.sortBy] &&
                ((c = gj.grid.methods.getColumnInfo(
                    a,
                    d.params[d.paramNames.sortBy]
                )),
                e.sort(
            ...
            return (
                e > -1 &&
                    ...
                    c &&
                        ...
                        c.attr(
                            "colspan",
                            gj.grid.methods.countVisibleColumns(a)
                        ),
        ...
        updateRow: function (a, b, c) {
            ...
            return (
                ...
                $.isArray(f.dataSource) &&
                    ((d = gj.grid.methods.getRecVPosById(a, b)),
                    (f.dataSource[d] = c)),
    ...
    (gj.grid.plugins.expandCollapseRows = {
        ...
        private: {
            expandDetail: function (a, b, c) {
                ...
                void 0 === typeof c &&
                    (c = gj.grid.methods.getId(j, h.primaryKey, j)),
            ...
            keepSelection: function (a, b) {
                ...
                c.keepExpandedRows &&
                    ($.isArray(c.expandedRows)
                        ? -1 == c.expandedRows.indexOf(b) &&
                          c.expandedRows.push(b)
                        : (c.expandedRows = [b]));
            },
            ...
            collapseAll: function () {
                ...
                return (
                    void 0 !== c.detailTemplate &&
                        ((a = gj.grid.methods.getColumnPositionByRole(
                            b,
                            "expander"
                        )),
                ...
                return (
                    e &&
                        ...
                        (c.html().replace(/\{(.+?)\}/g, function (a, c) {
                            ...
                            d = d.replace(
                                a,
                                gj.grid.methods.formatText(e[c], f)
                            );
                        }),
                        c.html(d)),
                    b
            ...
            $.extend(!0, a, gj.grid.plugins.expandCollapseRows.public),
                void 0 !== c.detailTemplate &&
                                ...
                                var c = $(this),
                                    d =
                                        gj.grid.plugins.expandCollapseRows
                                            .private;
                                "details" ===
                                c.closest("tr").next().attr("data-role")
                    ...
                    a.on("columnShow", function (b, c) {
                        gj.grid.plugins.expandCollapseRows.private.updateDetailsColSpan(
                            a
                        );
                    }),
                    ...
                    a.on("dataBound", function () {
                        ...
                        if (f.keepExpandedRows && $.isArray(f.expandedRows))
                            for (b = 0; b < f.expandedRows.length; b++)
                                (d = gj.grid.methods.getRowById(
                                    a,
                                    f.expandedRows[b]
                                )) &&
                                    d.length &&
                                    ((e =
                                        gj.grid.methods.getColumnPositionByRole(
                                            a,
                                            "expander"
                                        )),
    ...
    (gj.grid.plugins.inlineEditing.private = {
        ...
        displayMode: function (a, b, c, d) {
            ...
            "editOnly" !== c.mode &&
                ("edit" === b.attr("data-mode") &&
                    ...
                    "SELECT" === g[0].tagName.toUpperCase() &&
                    g[0].selectedIndex > -1
        ...
        updateChanges: function (a, b, c, d) {
            ...
            h.guid ||
                ...
                h.primaryKey &&
                    ((e = JSON.parse(
                        sessionStorage.getItem("gj.grid." + h.guid)
                    )),
                    e
    ...
    (gj.grid.plugins.inlineEditing.public = {
        getChanges: function () {
            return JSON.parse(
                sessionStorage.getItem("gj.grid." + this.data().guid)
            );
        },
        edit: function (a) {
            var b,
        ...
        private: {
            applyParams: function (a) {
                ...
                (b = JSON.parse(sessionStorage.getItem("gj.grid." + c.guid))),
                    b &&
                        b.optimisticPersistence &&
                        $.extend(d, b.optimisticPersistence),
            ...
            saveParams: function (a) {
                ...
                if (d.optimisticPersistence.sessionStorage) {
                    for (
                        b = 0;
                        b < d.optimisticPersistence.sessionStorage.length;
                        b++
                    )
    ...
    (gj.grid.plugins.pagination = {
        ...
        private: {
            init: function (a) {
                ...
                if (((d = a.data()), d.pager))
                    for (
                        d.params[d.paramNames.page] ||
                            (d.params[d.paramNames.page] = 1),
                            ...
                            h = $("<tfoot />").append(b),
                            a.append(h),
                            gj.grid.plugins.pagination.private.updatePagerColSpan(
                                a
                            ),
            ...
            localization: function (a) {
                "bootstrap" === a.uiLibrary
                    ? gj.grid.plugins.pagination.private.localizationBootstrap(
                          a
                      )
                    : "bootstrap4" === a.uiLibrary
                    ? gj.grid.plugins.pagination.private.localizationBootstrap4(
                          a
                      )
                ...
                void 0 === a.pager.leftControls && (a.pager.leftControls = []),
                    void 0 === a.pager.rightControls &&
                        (a.pager.rightControls = [
                            ...
                            $(
                                '<span class="gj-grid-mdl-pager-label">' +
                                    b.Of +
                                    "</span>"
                            ),
                            $(
                            ...
                            $(
                                ...
                                .attr("data-role", "page-previous")
                                .addClass(
                                    a.icons.first ? "gj-button-md-icon" : ""
                                ),
                            ...
                            ? (a.show(),
                              ...
                              a.change(function () {
                                  ...
                                  (c.params[c.paramNames.limit] = a),
                                      ...
                                      gj.grid.plugins.pagination.events.pageSizeChange(
                                          b,
                                          a
                                      );
                              }),
                ...
                if (((h = a.data()), h.pager)) {
                    for (
                        c =
                            0 === b
                                ? 0
                                : parseInt(h.params[h.paramNames.page], 10),
        ...
        public: {
            getAll: function (a) {
                ...
                return $.isArray(e.dataSource)
                    ? a
                        ? e.dataSource
                        : e.params[e.paramNames.limit] &&
                          e.params[e.paramNames.page]
    ...
    (gj.grid.plugins.responsiveDesign = {
        ...
        private: {
            ...
            updateDetails: function (a) {
                var b, c, d, e, f, g, h, i, j;
                for (
                    b = a.find('tbody > tr[data-role="row"]'),
                        c = a.data(),
                        d = 0;
                    d < b.length;
                    d++
        ...
        public: {
            ...
            makeResponsive: function () {
                var a,
                    ...
                    d = this.data(),
                    e =
                        gj.grid.plugins.responsiveDesign.private.orderColumns(
                            d
                        );
            ...
            $.extend(!0, a, gj.grid.plugins.responsiveDesign.public),
                b.responsive &&
                    ...
                    a.on("destroy", function () {
                        a.resizeCheckIntervalId &&
                            clearInterval(a.resizeCheckIntervalId);
                    }),
                    a.on("resize", function () {
                        a.makeResponsive();
                    })),
                b.showHiddenColumnsAsDetails &&
                    gj.grid.plugins.expandCollapseRows &&
                    (a.on("dataBound", function () {
                        gj.grid.plugins.responsiveDesign.private.updateDetails(
                            a
                        );
                    }),
                    a.on("columnHide", function () {
    ...
    (gj.grid.plugins.resizableColumns = {
        ...
        private: {
            init: function (a, b) {
                var c, d, e, f, g, h;
                if (
                    ((c = a.find('thead tr[data-role="caption"] th')), c.length)
                ) {
                    for (e = 0; e < c.length - 1; e++)
                        (d = $(c[e])),
                            (f = $(
                                '<div class="gj-grid-column-resizer-wrapper" />'
                            )),
                            (h = parseInt(d.css("padding-right"), 10) + 3),
                            (g = $(
                                '<span class="gj-grid-column-resizer" />'
        ...
        config: {
            base: {
                ...
                style: {
                    ...
                    targetRowIndicatorBottom:
                        "gj-grid-row-reorder-indicator-bottom",
                },
            },
        },
        private: {
                        ...
                        b.siblings('tr[data-role="row"]').each(function () {
                            ...
                            "true" === a.attr("data-droppable") &&
                                ...
                                a.droppable({
                                    ...
                                    out: gj.grid.plugins.rowReorder.private
                                        .droppableOut,
                                });
                        }),
                        f.trigger("mousedown");
                            ...
                            if (i.droppable("isOver", d)) {
                                for (
                                    j < k ? i.before(b) : i.after(b),
                                        l.records.splice(
                                            j - 1,
                                            0,
                                            l.records.splice(k - 1, 1)[0]
                                        ),
                                        c = i
                                            .parent()
                                            .find('tr[data-role="row"]'),
                                        f = 0;
                                    f < c.length;
                                    f++
                                )
                                ...
                                if (l.orderNumberField) {
                                    for (f = 0; f < l.records.length; f++)
                                        l.records[f][l.orderNumberField] =
                                            f + 1;
            ...
            getCSV: function (a) {
                ...
                if (g.length) {
                    for (b = 0; b < f.length; b++)
                        gj.grid.plugins.export.public.isColumnApplicable(
                            f[b]
                        ) &&
                            (d +=
                                '"' +
                                (f[b].title || f[b].field).replace(
                                    /<[^>]+>/g,
                                    " "
                                ) +
                                '",');
                        ...
                        b.siblings("th").each(function () {
                            ...
                            "true" === c.attr("data-droppable") &&
                                ...
                                c.droppable({
                                    ...
                                    out: gj.grid.plugins.columnReorder.private
                                        .droppableOut,
                                });
                        }),
                        d.trigger("mousedown"));
                ...
                for (d = 0; d < f.length; d++)
                    (e = $(f[d])),
                        c < b
                            ? e
                                  .find("td:eq(" + c + ")")
                                  .before(e.find("td:eq(" + b + ")"))
                            : e
                                  .find("td:eq(" + c + ")")
                                  .after(e.find("td:eq(" + b + ")"));
            },
            createDroppableOverHandler: function (a, b) {
                return function (c) {
                    var d = $(this),
                        e = a.data();
                    gj.grid.methods.getColumnPosition(
                        e.columns,
                        d.data("field")
                    ) <
                    gj.grid.methods.getColumnPosition(
        ...
        private: {
            init: function (a) {
                ...
                (b = void 0),
                    ...
                    (c.params[c.paramNames.groupByDirection] =
    ...
    (gj.tree.methods = {
        ...
        appendNode: function (a, b, c, d, e) {
            ...
            if (
                ...
                disabled
                    ...
                    : ($expander.on(
                          "click",
                          gj.tree.methods.expanderClickHandler(a)
                      ),
                      $display.on(
                          "click",
                          gj.tree.methods.displayClickHandler(a)
                      )),
        ...
        unselect: function (a, b, c) {
            ...
            if (
                ...
                (b
                    .removeClass(a.data().style.active)
                    .removeAttr("data-selected"),
                c)
            )
                for (e = b.find("ul>li"), d = 0; d < e.length; d++)
                ...
                for (b = 0; b < f.length; b++)
                    (c = $(f[b])),
                        "true" === c.attr("data-selected")
                            ...
                            : c.has("ul") &&
                              ((d = gj.tree.methods.getSelections(
                                  c.children("ul")
                              )),
        ...
        getDataByText: function (a, b, c) {
            ...
            for (d = 0; d < c.length; d++) {
                ...
                if (
                    ...
                    (e = gj.tree.methods.getDataByText(
                        a,
                        b,
                        c[d][f.childrenField]
                    ))
                ...
                for (c = 0; c < f.length; c++) {
                    if (
                        ...
                        b ===
                            d
                                .find(
                                    '>[data-role="wrapper"]>[data-role="display"]'
                                )
                                .text())
                    ) {
                        e = d;
        ...
        getChildren: function (a, b, c) {
            var d,
                ...
                c = void 0 === c || c;
            for (
                e = c ? b.find("ul li") : b.find(">ul>li"), d = 0;
                d < e.length;
                d++
            )
                f.push($(e[d]).data("id"));
        ...
        pathFinder: function (a, b, c, d) {
            ...
            for (e = 0; e < b.length; e++) {
                ...
                if (
                    gj.tree.methods.pathFinder(a, b[e][a.childrenField], c, d)
                ) {
    ...
    (gj.tree.plugins.checkboxes = {
        ...
        private: {
            ...
            nodeDataBound: function (a, b, c, d) {
                var e, f, g, h, i;
                0 ===
                    b.find('> [data-role="wrapper"] > [data-role="checkbox"]')
                        .length &&
                    ((e = a.data()),
                    (f = b.find(
        ...
        public: {
            ...
            check: function (a) {
                return (
                    gj.tree.plugins.checkboxes.private.update(
                        this,
                        a,
                        "checked"
                    ),
        ...
        private: {
            nodeDataBound: function (a, b) {
                ...
                c.length &&
                    ...
                    d.on(
                        "mouseup",
                        gj.tree.plugins.dragAndDrop.private.createNodeMouseUpHandler(
                            a
                        )
                    ));
            },
            ...
            createDragHandler: function (a, b, c) {
                var d = gj.tree.plugins.dragAndDrop.private.getTargetDisplays(
                        a,
                        b,
                        c
                    ),
                    e = gj.tree.plugins.dragAndDrop.private.getTargetWrappers(
                        a,
                        b
                    ),
                    f = a.data();
            ...
            refresh: function (a, b, c, d) {
                ...
                gj.tree.plugins.dragAndDrop.private.refreshNode(a, c),
                    ...
                    b.find('li[data-role="node"]').each(function () {
                        gj.tree.plugins.dragAndDrop.private.refreshNode(
                            a,
                            $(this)
                        );
                    }),
            ...
            refreshNode: function (a, b) {
                ...
                f.length && f.children().length
                    ...
                    : d.empty(),
                    c
                        .removeClass(g.style.dropAbove)
                        .removeClass(g.style.dropBelow),
            ...
            createDoneHandler: function (a, b) {
                return function (c) {
                    var d,
                        ...
                        g = a.data();
                    if (
                        ("string" == typeof c && JSON && (c = JSON.parse(c)),
                        c && c.length)
                    ) {
                        for (
                            f = b.children("ul"),
                                0 === f.length &&
                                    ((f = $("<ul />").addClass(g.style.list)),
                                    b.append(f)),
                                d = 0;
                            d < c.length;
                            d++
    ...
    (gj.checkbox.config = {
        ...
        bootstrap4: {
            style: {
                wrapperCssClass:
                    "gj-checkbox-bootstrap gj-checkbox-bootstrap-4",
            },
            iconsLibrary: "materialicons",
        },
        materialicons: {
    ...
    (gj.dropdown.methods = {
        ...
        initialize: function (a) {
            var b = a.data(),
                ...
                ).addClass(b.style.presenter),
                g = $(
                    '<ul role="list" class="' + b.style.list + '"></ul>'
        ...
        value: function (a, b) {
            return void 0 === b
                ? a.val()
                : (gj.dropdown.methods.select(a, b), a);
        },
        destroy: function (a) {
            var b = a.data(),
                c = a.parent('div[role="wrapper"]');
    ...
    (gj.datepicker.methods = {
        ...
        initialize: function (a, b) {
            ...
            0 === e.length
                ...
                "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary
                    ? "small" === b.size
                        ? (e.addClass("input-group-sm"),
                          a.addClass("form-control-sm"))
                        : "large" === b.size &&
                          (e.addClass("input-group-lg"),
                          a.addClass("form-control-lg"))
                    : "small" === b.size
                    ? e.addClass("small")
        ...
        createCalendar: function (a, b) {
            ...
            return (
                ...
                b.footer &&
                    ((e = $(
                        '<div role="footer" class="' + b.style.footer + '" />'
                    )),
                    (f = $(
                        '<button class="' +
                            b.style.button +
                ...
                b.modal &&
                    (h.wrapAll(
                        '<div role="modal" class="' + b.style.modal + '"/>'
                    ),
                    gj.core.center(h)),
                h
            );
        ...
        renderHeader: function (a, b, c, d) {
            ...
            c.header &&
                ...
                e.append(g),
                (f = $('<div role="date" class="selected" />').on(
                    "click",
                    function () {
        ...
        renderMonth: function (a, b, c) {
            ...
            for (
                s.off().empty(),
                    ...
                    v = v
                        .replace(
                            "mmmm",
                            gj.core.messages[c.locale].monthNames[g]
                        )
                        .replace("yyyy", h),
            ...
            for (
                o = gj.datepicker.methods.getNextMonth(g, h), l = 1;
                0 != d;
                l++
            )
            ...
            return (
                a.minDate &&
                    ("string" == typeof a.minDate
                        ...
                        : "function" == typeof a.minDate.getMonth &&
                          (b = a.minDate)),
                b
            );
        },
                ...
                a.maxDate &&
                    ("string" == typeof a.maxDate
                        ...
                        ? "string" == typeof (b = a.maxDate()) &&
                          (b = gj.core.parseDate(b, a.format, a.locale))
                        : "function" == typeof a.maxDate.getMonth &&
                          (b = a.maxDate)),
                b
            );
        },
            ...
            if ((e && b < e ? (d = !1) : f && b > f && (d = !1), d)) {
                if (a.disableDates)
                    if ($.isArray(a.disableDates))
                        ...
                        a.disableDates instanceof Function &&
                            (d = a.disableDates(b));
            ...
            return (
                0 === b.length &&
                    ...
                    0 === b.length &&
                        ...
                        0 === b.length &&
                            (b = a.find("td[day]:not(.disabled)").first()))),
                b
            );
        },
        value: function (a, b) {
    ...
    (gj.timepicker.methods = {
        ...
        initMouse: function (a, b, c, d) {
            a.off(),
                ...
                a.on(
                    "mousemove",
                    gj.timepicker.methods.mouseMoveHandler(b, c, d)
                ),
        ...
        createPicker: function (a) {
            ...
            return (
                ...
                c.modal &&
                    (d.wrapAll(
                        '<div role="modal" class="' + c.style.modal + '"/>'
                    ),
                    gj.core.center(d)),
                d
            );
        ...
        getPointerValue: function (a, b, c) {
            ...
            switch ((g < 0 && (g = 360 + g), c)) {
                case "ampm":
                    return (
                        (d = 12 - Math.round((12 * g) / 360)), 0 === d ? 12 : d
                    );
                case "24hr":
                    return (
                        (e = Math.sqrt(
                            Math.pow(f / 2 - a, 2) + Math.pow(f / 2 - b, 2)
                        )),
                ...
                case "minutes":
                    return (
                        (d = Math.round(60 - (60 * g) / 360)), 60 === d ? 0 : d
                    );
            }
        },
    ...
    (gj.timepicker.widget = function (a, b) {
        ...
        return (
            ...
            (c.destroy = function () {
                return gj.picker.widget.prototype.destroy.call(
                    this,
                    "timepicker"
                );
            }),
            ...
            (c.close = function () {
                return gj.picker.widget.prototype.close.call(
                    this,
                    "timepicker"
                );
            }),
    ...
    (gj.datetimepicker.methods = {
        ...
        getConfig: function (a, b) {
            var c = gj.widget.prototype.getConfig.call(this, a, b);
            return (
                (uiLibrary = a.hasOwnProperty("uiLibrary")
                    ? a.uiLibrary
                    : c.uiLibrary),
        ...
        initialize: function (a) {
            ...
            (j.datepicker.uiLibrary = j.uiLibrary),
                ...
                d.on(
                    "click",
                    gj.datetimepicker.methods.createShowDateHandler(a, b, j)
                ),
