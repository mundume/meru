...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('dashboard.create_route') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <legend>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 {{$errors->has('amount') ? 'has-error' : ''}}">
                            <small>Amount*</small>
                            <input type="text" name="amount" style="height:42px;" required class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-12 {{$errors->has('seaters') ? 'has-error' : ''}}">
                            <small>Seaters*</small>
                            <input type="number" name="seaters" style="height:42px;" required class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('departure') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="departure" style="height:42px;" required class="form-control">
                            <small class="text-danger">{{$errors->first('departure')}}</small>
                        </div>
                        <div class="col-md-6 {{$errors->has('destination') ? 'has-error' : ''}}">
                            <small>Destination*</small>
                            <input type="text" name="destination" style="height:42px;" required class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('mobile') ? 'has-error' : ''}}">
                            <small>Contact *</small>
                            <input type="text" name="mobile" style="height:42px;" value="{{ Auth::user()->c_mobile }}" required class="form-control">
                            <small class="text-danger">{{$errors->first('mobile')}}</small>
                        </div>
                        <div class="col-md-6">
                            <small>Assign Agent*</small>
                            <select class="form-control border-radius" style="height: 45px;text-transform: uppercase;" required name="agent">
                                <option selected data-default disabled>Assign Agent</option>
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('depart1') ? 'has-error' : ''}}">
                            <input type="text" name="depart1" style="height:42px;" class="form-control" id="depart1" required>
                            <small class="text-danger">{{$errors->first('depart1')}}</small>
                        </div>
                        <div class="col-md-6 {{$errors->has('arriv1') ? 'has-error' : ''}}">
                            <input type="text" name="arriv1" style="height:42px;" class="form-control" id="arriv1" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" name="depart2" style="height:42px;" class="form-control" id="depart2">
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="arriv2" style="height:42px;" class="form-control" id="arriv2">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" name="depart3" style="height:42px;" class="form-control" id="depart3">
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="arriv3" style="height:42px;" class="form-control" id="arriv3">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" name="depart4" style="height:42px;" class="form-control" id="depart4">
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="arriv4" style="height:42px;" class="form-control" id="arriv4">
                        </div>
                    </div>
                    <br>
                    <small>Pickups</small>
                    <div class="row">
                        <div class="col-md-9" id="dynamic_field">
                            <input type="text" name="pick_up[]" placeholder="Add Pickups Point (Optional)" value="Main Stage" readonly class="form-control" style="height:45px;" />
                            <br>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-success btn-block" type="submit" style="height: 42px;">ADD ROUTE</button>
                        </div>
                    </div>
                </div>
            </div>
