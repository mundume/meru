    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius:0px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">
                    <center style="text-transform: uppercase;"><b>Topup Agent Account</b>
                    </center>
                </h4>
            </div>
            <div class="modal-body">
                <form action="{{route('dashboard.topup_agent')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <input type="text" {{ $errors->cood->has('email') ? 'has-error' : '' }} name="email" required style="height:50px;" class="form-control" placeholder="Email Address*">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <input type="number" name="amount" {{ $errors->cood->has('amount') ? 'has-error' : '' }} required style="height:50px;" class="form-control" placeholder="Amount*">
                            <small class="text-danger">{{$errors->cood->first('amount')}}</small>
                        </div>
                    </div>
                    <br>
                    <button type="submit" class="btn btn-warning">TOPUP</button>
                </form>
            </div>
            <div class="modal-footer">
            </div>
